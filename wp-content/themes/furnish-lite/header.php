  ...
  <div class="head-top-inner">
  		<div class="top-left">
        	<?php if(get_theme_mod('email') != '') { ?>
        		<div class="mail">
                	<i class="fa fa-envelope" aria-hidden="true"></i> <a href="<?php echo esc_url('mailto:'.get_theme_mod('email')); ?>"><?php echo esc_url(get_theme_mod('email')); ?></a>
                </div><!-- mail -->
           <?php } ?>
...
<div id="header">
	<div class="header-inner">
      <div class="logo">
           <?php furnish_lite_the_custom_logo(); ?>
	...
	<div class="prime-inner">
        <div class="toggle">
                <a class="toggleMenu" href="#">
                    <?php esc_attr_e('Menu','furnish-lite'); ?>                
                </a>
         </div><!-- toggle -->    
        <div class="sitenav">                   
